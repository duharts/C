...
with tab3:
    ...
    # Ensure the terpene_data arrays are the same length
    terpene_data = {
    ...
    terpene_df = pd.DataFrame(terpene_data)  # Ensure arrays are of the same length
...
# Continue with other tabs (Metals, Pesticides, etc.) with the same format
